    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <form action="{{route('manageplan.update', $plans->id)}}" method = "post" class="needs-validation" novalidate>
                    {{csrf_field()}}
				    @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control @error('inventory_id') is-invalid @enderror" id="validationCustom02" name="inventory_id" required>
                                            <option selected disabled value="">Choose...</option>
                                            @foreach($inventory as $key => $datas)
                                            <option  {{ $plans->inventory_id === $datas->id? 'selected' : ''}}  value="{{$datas->id}}">{{$datas->res_type}}</option>
                                             @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select  class="form-control @error('location') is-invalid @enderror"   id="validationCustom02" name="location" required>
                                            ...
                                            <option  {{ $plans->location === $data->id ? 'selected' : ''}}  value="{{$data->id}}">{{$data->location_name}}</option>
                                             @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('resource_price') is-invalid @enderror" id="validationCustom03" name="resource_price" value="{{ $plans->resource_price }}"  placeholder="Number" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('num_seats') is-invalid @enderror" id="validationCustom04" name="num_seats"   value="{{ $plans->num_seats }}" placeholder="Count" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('area') is-invalid @enderror" id="validationCustom05" name="area"  value="{{ $plans->area }}" placeholder="in SqFt" required>
                                        @if ($errors->has('area'))
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="validationTextarea06" placeholder="Description"  name="description"  rows="3"  required>{{ $plans->description }}</textarea>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('meeting_room_credits') is-invalid @enderror"
                                            id="validationCustom07"name="meeting_room_credits" value="{{ $plans->meeting_room_credits }}" 
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('printer_credits') is-invalid @enderror" id="validationCustom08" 
                                            name="printer_credits" placeholder="Printer Credits" value="{{ $plans->printer_credits }}"   required>
