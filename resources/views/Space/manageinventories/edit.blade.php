                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text" class="form-control  @error('title') is-invalid @enderror" id="validationCustom01" value="{{ $inventory->title }}" name="title"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('hsn_code') is-invalid @enderror" id="validationCustom03"  value="{{ $inventory->hsn_code }}"name="hsn_code"
