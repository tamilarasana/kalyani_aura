                            ...
                            <div class=" col-md-12  mb-4">
                                <div class="card timeline">
                                    <div class="card-header">
                                        <strong class="card-title">Visitors Today</strong>
                                        {{-- <a class="float-right small text-muted" href="#!">View all</a> --}}
                                    </div>
                                    <div class="card-body">
                                        @foreach ($reasonvisits as $reasonvisits)
                                            <div class="pb-3 timeline-item item-success">
                                                <div class="pl-5">
                                                    <div class=" row mb-3 ">
                                                        <h4>{{ $reasonvisits->first_name }}&nbsp;{{ $reasonvisits->last_name }}
                                                        </h4>
                                                        <h4 class="text-muted  mx-2">
                                                            {{ $reasonvisits->time_check_in }}</h4>
                                                        <h4>Interview</h4>
                                                    </div>
                                                </div>
                                            </div>
