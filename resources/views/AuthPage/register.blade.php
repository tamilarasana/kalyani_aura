                    ...
                    <form     id="example-form" class=" mt-4">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input id="inputUsername" name="name" type="text"
                                    class="form-control required" placeholder="User Name" value="{{ old('name') }}" required>
                                <span class="text-danger">@error('name'){{ $message }} @enderror</span>
                                </div>
                            <div class="form-group">
                                <label for="inputEmail">Email address *</label>
                                <input id="inputEmail" name="email" type="email"
                                    class="form-control required" placeholder="Email address"   value="{{ old('email') }}" required>
