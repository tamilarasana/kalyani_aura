...
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                <form action="{{ route('announcement.update', $announcement->id) }}" method="post" class="needs-validation"
                        ...
                        <div class="col-md-12">
                            <div class="card shadow mb-4">
                                <div class="card-header">
                                    <strong class="card-title">Edit Announcement</strong>
                                </div>
                                <div class="card-body">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select  class="form-control @error('location') is-invalid @enderror"   name="location" required>
                                            ...
                                            <div class="form-group mb-3">
                                                @if (isset($announcement->image))
                                                    <input type="file" id="validationCustom07"
                                                        ...
                                                        <br><br>
                                                    <img src="{{ str_replace('public/', '', asset('storage/' . $announcement->image)) }}"
